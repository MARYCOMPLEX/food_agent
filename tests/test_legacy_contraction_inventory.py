...
@pytest.mark.parametrize(
    ...
    (
        ...
        "src/api/README.md",
        "src/food_agent/__init__.py",
        "src/food_agent/schemas/__init__.py",
        "src/food_agent/services/__init__.py",
        "src/food_agent/agents/__init__.py",
        "src/food_agent/composition/research_task.py",
        "src/food_agent/composition/adapters/repositories.py",
