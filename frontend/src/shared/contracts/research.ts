...
const profile = z.object({
  ...
  images: z.array(z.string().max(4096)).max(256).optional(),
  recommendedDishes: z.array(z.string().max(4096)).max(256).optional(),
  promotions: z.array(z.string().max(4096)).max(256).optional(),
