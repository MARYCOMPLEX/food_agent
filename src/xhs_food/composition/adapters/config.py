...
def build_owner_config(
    ...
    return OwnerConfigFacade(
        ...
        temporal=TemporalConfigView(
            ...
            account_auth_queue=target.temporal_account_auth_queue,
            account_auth_enabled=target.temporal_account_auth_enabled,
            account_auth_max_concurrent_activities=target.temporal_account_auth_max_concurrent_activities,
            account_auth_max_concurrent_workflows=target.temporal_account_auth_max_concurrent_workflows,
            account_auth_priority=target.temporal_account_auth_priority,
