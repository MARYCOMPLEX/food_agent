...
_EXPORT_MODULES = {
    ...
    "ACCOUNT_AUTH_CANCEL_ACTIVITY": "xhs_food.foundation.platform_login_temporal",
    "ACCOUNT_AUTH_CANCEL_SIGNAL": "xhs_food.foundation.platform_login_temporal",
    "ACCOUNT_AUTH_COOKIE_IMPORT_ACTIVITY": "xhs_food.foundation.platform_login_temporal",
    "ACCOUNT_AUTH_CREATE_QR_ACTIVITY": "xhs_food.foundation.platform_login_temporal",
    "ACCOUNT_AUTH_POLL_ACTIVITY": "xhs_food.foundation.platform_login_temporal",
    "ACCOUNT_AUTH_PHONE_LOGIN_ACTIVITY": "xhs_food.foundation.platform_login_temporal",
    "ACCOUNT_AUTH_TASK_QUEUE": "xhs_food.foundation.platform_login_temporal",
    "ACCOUNT_AUTH_WORKFLOW_TYPE": "xhs_food.foundation.platform_login_temporal",
    "PlatformLoginTemporalActivities": "xhs_food.foundation.platform_login_temporal",
    "TemporalAccountAuthWorkflow": "xhs_food.foundation.platform_login_temporal",
    "account_auth_activity_config": "xhs_food.foundation.platform_login_temporal",
    "build_account_auth_workflow_start": "xhs_food.foundation.platform_login_temporal",
}
