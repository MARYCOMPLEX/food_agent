...
from food_agent.common import extract_json
...
from food_agent.domain_packs.food.decision import FoodDecisionPolicy
from food_agent.domain_packs.food.preprocessing import (
    ProcessedComment,
    format_comments_for_llm,
    preprocess_comments,
)
from food_agent.domain_packs.food.scoring import (
    ShopScore,
    calculate_scores,
    get_top_shops,
)
from food_agent.prompts import (
    COMMENT_ANALYSIS_SYSTEM_PROMPT,
    COMMENT_ANALYSIS_USER_PROMPT,
)
from food_agent.schemas import (
