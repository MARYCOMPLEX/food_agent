...
from food_agent.contracts import PersonalizationCanaryObservation
...
class RefreshMediaTelemetry:
    ...
    def __init__(self, *, enabled: bool = False, tracer: Any | None = None) -> None:
        self._enabled = enabled
        self._tracer = tracer or trace.get_tracer("food_agent.refresh_media")
...
class EvidenceShadowTelemetry:
    ...
    def __init__(self, *, enabled: bool = False, tracer: Any | None = None) -> None:
        self._enabled = enabled
        self._tracer = tracer or trace.get_tracer("food_agent.evidence.shadow")
