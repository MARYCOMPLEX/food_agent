...
from food_agent.foundation.telemetry_metrics import (
    otel_queue_size,
    record_otel_event,
    set_otel_health,
)
...
class OTLPHTTPObservationBackend:
    ...
    def _ensure_sdk(self) -> bool:
        ...
        try:
            ...
            self._sdk_tracer = provider.get_tracer("food_agent", OBSERVATION_EXPORTER_VERSION)
            return True
        except Exception:
        ...
        "resourceSpans": [
            {
                ...
                "scopeSpans": [{"scope": {"name": "food_agent"}, "spans": spans}],
            }
        ]
    }
