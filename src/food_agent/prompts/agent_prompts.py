...
- :mod:`food_agent.prompts.intent` (INTENT_PARSER_*)
- :mod:`food_agent.prompts.analyzer` (ANALYZER_*)
- :mod:`food_agent.prompts.orchestrator` (ORCHESTRATOR_SYSTEM_PROMPT,
  REPORT_GENERATION_PROMPT)

Re-exported here so any `from food_agent.prompts.agent_prompts import ...` still
resolves.
"""
