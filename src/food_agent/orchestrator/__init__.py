...
_EXPORT_MODULES = {
    "ResearchCoordinator": "food_agent.orchestrator.coordinator",
    "StepScheduler": "food_agent.orchestrator.scheduler",
    "XHSFoodOrchestrator": "food_agent.orchestrator.core",
    "REFRESH_CANCEL_SIGNAL": "food_agent.orchestrator.refresh_media",
    "REFRESH_EXECUTE_ACTIVITY": "food_agent.orchestrator.refresh_media",
    "REFRESH_TASK_QUEUE": "food_agent.orchestrator.refresh_media",
    "REFRESH_WORKFLOW_TYPE": "food_agent.orchestrator.refresh_media",
    "RefreshActivities": "food_agent.orchestrator.refresh_media",
    "TemporalRefreshWorkflow": "food_agent.orchestrator.refresh_media",
    "build_refresh_workflow_start": "food_agent.orchestrator.refresh_media",
    "refresh_activity_config": "food_agent.orchestrator.refresh_media",
    "MEDIA_CANCEL_SIGNAL": "food_agent.orchestrator.refresh_media",
    "MEDIA_FETCH_ACTIVITY": "food_agent.orchestrator.refresh_media",
    "MEDIA_TASK_QUEUE": "food_agent.orchestrator.refresh_media",
    "MEDIA_WORKFLOW_TYPE": "food_agent.orchestrator.refresh_media",
    "MediaActivities": "food_agent.orchestrator.refresh_media",
    "TemporalMediaWorkflow": "food_agent.orchestrator.refresh_media",
    "media_activity_config": "food_agent.orchestrator.refresh_media",
    "build_media_workflow_start": "food_agent.orchestrator.refresh_media",
}
...
def __getattr__(name: str) -> Any:
    ...
    if module_name is None and name in _RELIABLE_EXPORTS:
        module_name = "food_agent.orchestrator.reliable_task"
